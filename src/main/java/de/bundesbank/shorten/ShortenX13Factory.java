...
public class ShortenX13Factory extends ComposedProcDocumentItemFactory<X13Document, Map<String, CompositeResults>> {
    ...
    public ShortenX13Factory() {
        super(X13Document.class, DIAGNOSTIC_SHORT, new DiagnosticsShortenExtractor(), new DefaultItemUI<IProcDocumentView<X13Document>, Map<String, CompositeResults>>() {
            @Override
    ...
    private static class DiagnosticsShortenExtractor extends DefaultInformationExtractor<X13Document, Map<String, CompositeResults>> {
        ...
        public Map<String, CompositeResults> retrieve(X13Document source) {
            ...
            int firstyears = 3;
            while (firstyears <= 10) {
                X13Specification shortSpec = currentSpec.clone();
                EstimateSpec estimateSpec = shortSpec.getRegArimaSpecification().getEstimate();
